...
const App = new Vue({
  ...
  data: {
    ...
    chatRoom: null,
    appId: 'GAGfMlsxQNOwzvdqFnYdD5Ai-gzGzoHsz',
    appKey: 'N5xoP600yZ5UlOuBwNEIA9Cn',
    server: 'https://gagfmlsx.lc-cn-n1-shared.com', // REST API 服务器地址
  },
  methods: {
    randomString(length) {
      let str = ''
  ...
  mounted() {
    ...
    // this.socket = io('http://localhost:2233'); // 替换成你的websocket服务地址
